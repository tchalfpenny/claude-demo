...
class TestRAGSystemQuery:
    ...
    @patch('anthropic.Anthropic')
    def test_query_with_tool_use(self, mock_anthropic_class, test_config, sample_course, sample_course_chunks):
        ...
        mock_final_response.content = [Mock(text="Machine learning is covered in lesson 2")]
