...
class TestCourseSearchToolIntegration:
    ...
    def test_lesson_link_retrieval_flow(self, mock_vector_store):
        ...
        # Configure mock to return lesson link
        mock_vector_store.get_lesson_link.return_value = "https://example.com/specific-lesson"
        ...
        sources = tool.last_sources
        assert any("LINK:https://example.com/specific-lesson" in source for source in sources)