...
class TestVectorStoreConfiguration:
    ...
    def test_max_results_zero_issue(self, temp_chroma_path):
        ...
        assert results.is_empty(), "With MAX_RESULTS=0, search should return empty results"
...
class TestVectorStoreSearch:
    ...
    def test_search_without_filters(self, temp_chroma_path, sample_course, sample_course_chunks):
    ...
    def test_search_with_both_filters(self, temp_chroma_path, sample_course, sample_course_chunks):
        ...
        results = vector_store.search(
            "RAG", 
            course_name="RAG System Fundamentals",
            lesson_number=1
        )
    ...
    def test_search_nonexistent_course(self, temp_chroma_path, sample_course, sample_course_chunks):
    ...
    def test_search_with_limit_override(self, temp_chroma_path, sample_course, sample_course_chunks):
...
class TestVectorStoreErrorHandling:
    ...
    def test_search_with_invalid_path(self):
        ...
        with pytest.raises(Exception):
            vector_store = VectorStore("/invalid/path", "all-MiniLM-L6-v2", max_results=5)
